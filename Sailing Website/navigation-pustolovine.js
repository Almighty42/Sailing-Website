...
window.addEventListener('load', function () {
    ...
    headerLink1.addEventListener("click", () => { clickHandler('link-1'); handleHeader("pustolovine") });
    headerLink2.addEventListener("click", () => { clickHandler('link-2'); handleHeader("pustolovine") });
    headerLink3.addEventListener("click", () => { clickHandler('link-3'); handleHeader("pustolovine") });
